  ...
  plugins: [
    ...
    function({ addUtilities, theme, variants }: any) {
      const gradientBorderUtilities = {
        '.border-gradient-pink-rose': {
          position: 'relative',
          '&::before': {
            content: '""',
            position: 'absolute',
            inset: 0,
            padding: '1px', // Adjust border width
            borderRadius: 'inherit',
            background: `linear-gradient(to right, ${theme('colors.pink.500')}, ${theme('colors.rose.500')})`,
        ...
        '.border-gradient-blue-violet': {
          ...
          '&::before': {
            ...
            padding: '1px',
            borderRadius: 'inherit',
            background: `linear-gradient(to right, ${theme('colors.blue.500')}, ${theme('colors.violet.500')})`,
            WebkitMask: 'linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)',
            WebkitMaskComposite: 'xor',
            maskComposite: 'exclude',
            pointerEvents: 'none',
      ...
      addUtilities(gradientBorderUtilities, variants('borderGradient'));
    },
  ],
};
